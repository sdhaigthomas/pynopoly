...
def portfolio(player_keystroke, player_no):
    ...
    if purchase == "y":
        ...
        # we need to check if the set is eligible for house purchase...
        ...
        if set_colour == "transparent" or set_colour == "white":
            ...
            if set_size == set_size_owned:
                ...
                no_of_houses = int(input("how many houses do you want to buy for each property on the set coloured " + set_colour))

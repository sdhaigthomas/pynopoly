...
community_chest = [["Advance to Go (Collect £200)", 200, 0],
                  ...
                  ["From sale of stock you get £50", -1, -1],
                  ["Get Out of Jail Free", -1,-1],
...
def prop_available(square_no, player_no):
    ...
    if squares[square_no][4] == 'bank':
        ...
        if squares[square_no][4] == "NA":
            ...
            houses = squares[square_no][11]
            print("rent! Checking if you have £" + str(squares[square_no][5 + houses]))
    return player_no   
...
def go_to_jail():
    ...
    #print(player)
    return player[active_player][3], player[active_player][5]
...
while True:
    ...
    new_square = new_square_cal(active_player, 20, 10)

...
def prop_available(square_no, player_no, sent_through_chance_card):
    ...
    elif active_player == int(squares[square_no][4]): # you have landed on your own property
        print("This property belongs to you. Welcome home!")

    elif active_player != int(squares[square_no][4]): # you have landed on someone else's property
    ########### make new rent function ############################
        print("active player = ", active_player, "square name = ", squares[square_no][1], " owner of the square = ", squares[square_no][4])
